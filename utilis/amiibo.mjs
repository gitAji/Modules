...
function listAmiibos(amiibos, out) {
    ...
    for (let amiibo of amiibos) {
        //console.log (amiibo);
        output += `<div class="w-1/4 p-2">
        <details>
            <summary class="bg-yellow-100 p-5">${amiibo.name}</summary>
            <div class="object-fit"><img src="${amiibo.image}" class="w-1/3"  alt="${amiibo.name}"></div>
            <ul class="p-3">
